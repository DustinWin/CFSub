...
2. [**cmliu-cfbestip.txt**](https://github.com/DustinWin/CFSub/releases/download/CFBestIP/cmliu-cfbestip.txt) 源采用 <https://cf.090227.xyz>
3. [**cfspeeddns-cfbestip.txt**](https://github.com/DustinWin/CFSub/releases/download/CFBestIP/cfspeeddns-cfbestip.txt) 源采用 <https://ip.164746.xyz>
4. [**wetest-cfbestip.txt**](https://github.com/DustinWin/CFSub/releases/download/CFBestIP/wetest-cfbestip.txt) 源采用 <https://www.wetest.vip/page/cloudflare/address_v4.html> 和 <https://www.wetest.vip/page/cloudflare/address_v6.html> 组合
